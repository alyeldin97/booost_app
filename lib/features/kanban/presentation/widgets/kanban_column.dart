...
class KanbanColumn extends StatelessWidget {
  ...
  final void Function(TaskModel task, String newStatus) onDropTask;
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    PopupMenuButton<String>(
                      ...
                      itemBuilder: (context) => const [
                        PopupMenuItem(value: 'add', child: Text('Add task')),
              ...
              Expanded(
                child: tasks.isEmpty
                    ? Center(
                        child: Text('No tasks', style: AppTextStyles.caption),
                      )
                    : ListView.separated(
